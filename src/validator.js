const validator = {
    isValid: function (inputNumero) {
      ...
      for (let i = 0; i < numberLunh.length; i++) {
        // si el número es impar se multiplica por 2, buscar la posicion y multiplica
      ...
      sumaTotal = sumaTotal + sumaImpar;// se suman los pares e impares.
